      ...
      <section className="py-24 px-8 md:px-16 bg-[#f8f9fc]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Feature delay="360ms" color={BLUE} title="Study Resources" desc="Access, bookmark, and rate academic materials uploaded by faculty members." icon={
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
            }/>
          </div>
        </div>
      </section>
